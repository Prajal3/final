...
import { createGroup,inviteMembers, sendMessage,removeMember, updateGroup, getMessages, leaveGroup, getMyGroups, getGroupById } from "../controllers/group.controller.js";
...
router.post("/groups/:groupId/invite", protectRoute, inviteMembers);
